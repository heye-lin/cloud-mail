const en = {
    ...
    domainDesc: 'Domain',
    addTurnstileSecret: 'Add captcha secret',
    ...
    otherEmailDesc: 'Emails can be forwarded to an external mailbox after the destination address is verified',
